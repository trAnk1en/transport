	...
	<div class="wrapper">
		...
		<?php 
			...
			if(isset($_POST['submit']))
			{
				...
				//Check whether the image is selected or not and set the value for image accoridingly
				...
				if(isset($_FILES['image']['name']))
				{
					...
					//Get the extension of our image (jpg, png, gif, etc) e.g. "shipping type 1.jpg"
					$ext = end(explode('.', $image_name));
					
					//Rename the image
					$image_name = "shipping_type_category_".rand(000, 999).'.'.$ext; //e.g. shipping_type_category_335.jpg
				...
				{
					//Don't Upload image adn set the image_name value as blank
					$image_name="";
				}
				...
				//3. Execut the Query and Save in Datbase
