<?php include('partials-front/menu.php'); ?>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Shipping Port</h2>
			...
			<?php 
			 	...
			 	if($count>0)
				{
					while($row=mysqli_fetch_assoc($res))
					{
						...
						<a href="<?php echo SITEURL; ?>category-shipping-type.php?category_id=<?php echo $id; ?>">
							<div class="box-3 float-container">
								<?php 
									...
									{
										?>
										<img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="Normal Ship" class="img-responsive img-curve">
										<?php
									}
								?>
    ...
    <section class="food-menu">
        <div class="container">
			...
			<?php 
				...
				$sql2 = "SELECT * FROM tbl_shipping_type WHERE featured='Yes'";
